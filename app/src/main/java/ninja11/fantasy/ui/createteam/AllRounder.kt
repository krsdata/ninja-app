...
class AllRounder(allRounders: ArrayList<PlayersInfoModel>, val matchObject: UpcomingMatchesModel, val playerType:Int) : Fragment() {
    var count=0
    private lateinit var mListener: OnTeamCreateListener
    var allRounders = allRounders
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        allRounders = CricketPlayersFilters.getPlayersbyOddEvenPositions(allRounders,matchObject)
        mBinding!!.labelPlayersCounts.setText("Select 1 - 4 All-Rounders")
